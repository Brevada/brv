...
$this->addResource('/css/widgets/widgets2.css');
...
?>
        ...
        <div class="option">
            ...
            <div class="option_right">	
                <div class="option_title">
                	<strong>The Feedback Page:</strong> Copy and paste this code onto a page on your website.
                </div>
                <br />
		<textarea class="option_ta"><iframe id="frame1" onload="iframeLoaded1()" src="http://brevada.com/mobile/profile/profile.php?name=<?php echo $url_name; ?>" frameBorder="0"></iframe></textarea>	
            </div>
        ...
        <div class="option">
            ...
            <div class="option_right">	
                <div class="option_title">
                	<strong>Email Gathering:</strong> Copy and paste this code into an HTML email, this Widget is <strong>compatible with email clients</strong>.
                </div>
                <br />
		<textarea class="option_ta">
        	<style>
						#rad{
							width:9px;
						}
					...
					<form id="form" method="get" action="http://brevada.com/overall/public/email_friendly_insert.php" >
						...
						<div id="whole_container" style="padding:6px; border:1px solid #dcdcdc; background:#f8f8f8;">
							...
							<div style="float:left; padding:6px;text-overflow: ellipsis;width: 150px;white-space: nowrap;overflow: hidden;">
								<strong><?php echo $post_name; ?></strong><br />
							...
							<div class="text_clean" style="margin:5px;">
								<!-- EDIT HERE -->
								<a href="http://brevada.com/profile/profile.php?name=<?php echo $url_name; ?>&reviewer=PUT EMAIL HERE" target="_TOP">Not Working?</a>
								<!-- -->	
							</div>
        ...
        <div class="option">
            ...
            <div class="option_right">	
                ...
                <br />
		<textarea	class="option_ta"><a href="http://brevada.com/<?php echo $url_name; ?>" target="_top"><img src="http://brevada.com/images/giveusfeedback.png" style="width:280px;" /></a></textarea>	
            </div>
