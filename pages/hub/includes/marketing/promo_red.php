...
$this->addResource('/css/promo_red.css');
...
<img src="/images/promo_rectangle.png" style="height:350px;"/>
<div style="margin-left:440px; margin-top:-190px; color:#fff; font-family:tahoma; font-size:50px;"><?php echo $url_name; ?></div>
