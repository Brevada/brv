...
$this->addResource('/css/mobile/profile_mobile.css');
	...
	<div id="pod">
		...
		<div id="top_holder" style="height:170px; margin-top:-170px; background:rgba(0,0,0,0.7);">
			...
			<?php  if($extension=="none"){ ?>
				<img id="pic" src="/user_data/user_images/default.jpg"  />
				<?php  } else { ?>
				<img id="pic" src="/user_data/user_images/<?php  echo $user_id; ?>.<?php  echo $user_extension; ?>"  />
				<?php  } ?>
			</div>
	...
	document.getElementById("message_button").style.display='none';
		...
		<div style="margin-top:1px;">
			...
			<div class="post">
				...
				<div id="pic_holder2" style="">
				  <?php post_pic('90px','auto',$post_id, $user_id, $post_extension, $user_extension); ?>
				</div>
                
				<div id="info_holder" id="overflow" style="margin-left:10px;">
				...
				<div style="">
				<a  id="expanderHead1<?php echo $post_id; ?>" data-reveal-id="unlock"><div id="button3" style="float:left; width:90px;"><span id="expanderSign1<?php echo $post_id; ?>">+</span> Rate It</div></a> 
                
                 <a  id="expanderHead2<?php echo $post_id; ?>" data-reveal-id="unlock"><div id="button3" style="float:left; width:90px;"><span id="expanderSign2<?php echo $post_id; ?>">+</span> Comment</div></a>
