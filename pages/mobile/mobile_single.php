<?php
$this->addResource('/css/mobile/mobile_single.css');
...
$post_id = @intval(Brevada::validate(Brevada::FromPOSTGET('id')));
...
$id = ''; $post_id = ''; $user_id = ''; $name = ''; $post_name = ''; $type = ''; $post_extension = '';
...
function message_show() {
	...
	document.getElementById("message_button").style.display='none';
		...
		<?php $this->add(new View('../pages/mobile/new_rater.php', array('country' => $country, 'post_id' => $post_id, 'check_rate'=>$check_rate))); ?>
