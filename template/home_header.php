...
<div class="pre-loader">
        <div class="load-con">
            <!-- <img src="img/eco/logo.png" class="animated fadeInDown logo" alt=""> -->
            <div class="spinner">
                ...
                <div class="container">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="index.html">
                            <img src="/images/brevada.png" alt="" class="logo">
                        </a>
                    </div>
        ...
        <div class="jumbotron container">
					...
					<div class="col-md-8">
						<div class="large_white_bold">
                           <h1>Transform your restaurant with <span class="highlighted">VALUABLE FEEDBACK</span></h1>
                        </div>
			   		...
			   		<div class="col-md-4 hidden-xs hidden-sm img-holder">
