					...
					<div style="float:right;">
						<form method="post" action="/home/search.php">
							<div style="float:left;">
								<input class="search" name="needle" value="Search for a page" onFocus="if(this.value == 'Search for a page'){this.value = '';}" onBlur="if(this.value == ''){this.value='Search for a page';}" style='width: 350px;' />
							</div>
							<div style="float:right;">
